...
5. **Statut** : ✅ déployé & vérifié 2026-06-18 (306 tests, dry-run + vrai run OK, audit 🟢). Anaïs backfillée en base (`pi_3Ti3le…`, place_date 31/07). Reste : valider le 1er placement réel (31/07) + lien manuel François (AGENDA 02/07).
