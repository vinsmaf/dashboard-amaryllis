# ADR — Archive Juin 2026 (locatif-dashboard)

> Archive mensuelle des décisions structurantes de juin 2026, extraite de `../ADR.md` le 2026-07-04
> (consolidation mémoire — fichier principal devenu trop volumineux, split par calendrier).
> Format 5 lignes inchangé : **Choix · Alternatives refusées · Conséquences attendues · Périmètre · Statut**.
...
> (Point 5 restauré le 2026-07-04 — était perdu/mal-fusionné avec l'entrée suivante lors d'une session antérieure, cf. consolidation.)
...
## ADR-DEPLOY-BRANCH-001 · 2026-06-20 · `deploy-pages.sh` force la branche de PRODUCTION
> (Renommé le 2026-07-04 — collision d'ID avec ADR-DEPLOY-001 du 2026-06-23, contenu distinct conservé tel quel.)
...
## ADR-TRACKING-ATTRIBUTION-001 · 2026-06-07 · Attribution first-click via trackingAttribution.js → Stripe metadata
> (Renommé le 2026-07-04 — collision d'ID avec ADR-TRACKING-001 du 2026-06-15, contenu distinct conservé tel quel.)
