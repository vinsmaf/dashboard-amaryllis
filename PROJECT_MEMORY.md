...
- **SEO — total au 02/06** : 11 guides longue-traîne créés (lots 2+3) + fondation hub & spoke (clusters/maillage crawlable/meta runtime/JSON-LD). **Prochaine étape = piloter par les données GSC à J+30** (baseline `docs/seo/baseline-2026-06-02.md`) + off-page (Vincent) + netlinking.
