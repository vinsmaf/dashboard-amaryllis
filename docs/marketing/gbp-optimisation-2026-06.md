...
## 1) Villa Amaryllis (Sainte-Luce — chemin Bois Grillé, Clos de Bellevue)

### Description (à coller dans « Description de l'entreprise », ≤ 750 car.)
> Villa Amaryllis — villa de standing avec piscine à débordement (eau salée) et vue mer, sur les hauteurs de Sainte-Luce, dans le Sud de la Martinique. 3 chambres climatisées avec salle de bain, vaste terrasse, carbet traditionnel, cuisine équipée et coin barbecue. Idéale pour une famille ou un petit groupe (jusqu'à 6 personnes) en quête de calme et d'intimité, à quelques minutes des plus belles plages. Réservation en direct avec le propriétaire sur villamaryllis.com : environ 15 % moins cher qu'Airbnb, sans frais de service. Accueil chaleureux (planteur de bienvenue), livret digital et conseils d'hôte local.

### Catégories
- **Principale** : Maison de vacances *(déjà en place)*
- Secondaires : Hébergement de vacances · Location de vacances

### Attributs à cocher (s'ils existent pour la catégorie)
Piscine · Wi-Fi gratuit · Parking gratuit sur place · Climatisation · Vue sur la mer · Cuisine équipée · Barbecue · Animaux (selon ta politique) · Espace extérieur/terrasse

### Lien site (champ « Site Web »)
`https://villamaryllis.com/amaryllis`

### Post Google (type « Nouveautés » — à publier)
> 🌴 Envie de la Martinique côté Sud ? Villa Amaryllis vous attend à Sainte-Luce : piscine à débordement vue mer, carbet, calme absolu. **Réservez en direct sur villamaryllis.com et économisez ~15 % vs Airbnb**, sans frais de service. La haute saison (déc–avril) se réserve tôt !
> **Bouton : « Réserver »** → https://villamaryllis.com/amaryllis

---

## 2) Résidence Amaryllis (Sainte-Luce — quartier Montravail)

### Description (≤ 750 car.)
> Résidence Amaryllis — résidence privée au calme, quartier Montravail à Sainte-Luce (Martinique). Plusieurs logements indépendants joliment équipés (studio et appartements), piscine, terrasses et jardin tropical, à proximité des plages, commerces et distilleries du Sud. Parking sur place, Wi-Fi, climatisation. Parfait pour un séjour reposant en couple, en famille ou entre amis ; possibilité de réunir plusieurs logements pour un grand groupe (jusqu'à 11 personnes). Accueil chaleureux avec cocktail de bienvenue. Réservation en direct sur villamaryllis.com : environ 15 % moins cher qu'Airbnb, sans frais de service.

### Catégories
- **Principale** : Maison de vacances *(ou « Résidence de tourisme » si proposé)*
- Secondaires : Hébergement de vacances · Location de vacances

### Attributs à cocher
Piscine · Wi-Fi gratuit · Parking gratuit · Climatisation · Cuisine équipée · Espace extérieur/jardin · Animaux (selon politique)

### Lien site (champ « Site Web »)
`https://villamaryllis.com/location-groupe-sainte-luce`
...
### Post Google (à publier)
> ☀️ Un séjour au calme à Sainte-Luce ? La Résidence Amaryllis propose studio et appartements avec piscine, à 5 min des plages du Sud. En famille, en couple ou en groupe (jusqu'à 11 pers. en combinant les logements). **Réservez en direct sur villamaryllis.com**, ~15 % moins cher qu'Airbnb, sans frais de service.
> **Bouton : « Réserver »** → https://villamaryllis.com/location-groupe-sainte-luce

---

## 3) Photos (action Vincent — upload de tes fichiers)
Pour les 2 fiches, ajouter **5–10 photos récentes et nettes** (Google favorise les fiches avec photos fraîches) :
...
## 4) Rappels
- **Posts Google** = signal de fraîcheur fort → en publier ~1 toutes les 2-3 semaines (saison, dispo, offre). Je peux te les pré-rédiger en série.
