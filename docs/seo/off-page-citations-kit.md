# Kit citations off-page (NAP) — SEO local Amaryllis
...
## NAP canonique (à coller à l'identique)

**Nom** : Amaryllis Locations
...
## Checklist plateformes (action Vincent — gratuit sauf mention)

| Plateforme | Statut | Lien d'inscription | Note |
|---|---|---|---|
