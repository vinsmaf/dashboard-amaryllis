...
export const ENDPOINTS_DIGEST = [
  ...
  "/api/send-poststay (send-poststay.js) — crm-006 : Email post-séjour J+3 — demande d'avis Google + NPS 1 question",
  "/api/send-pre-depart (send-pre-depart.js) — Cron J-1 checkout : email la veille du départ — consignes, heure de départ, late check-out, fidélité, avis Google.",
  "/api/send-prearrivee (send-prearrivee.js) — crm — Email pré-arrivée J-3 pour les RÉSERVATIONS DIRECTES uniquement.",
  "/api/send-predepart (send-predepart.js) — crm — Email pré-départ J-1 pour les RÉSERVATIONS DIRECTES uniquement.",
