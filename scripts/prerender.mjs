...
const ROUTES = [
  ...
  {
    path: "/zandoli",
    title: "Zandoli — Location villa Martinique piscine privée | Résidence Amaryllis",
    desc:  "Villa Zandoli à Sainte-Luce, Martinique. Piscine privée, vue mer, jardin tropical. 4 personnes. Réservation directe sans frais de service.",
    image: `${BASE}/photos/zandoli/01.webp`,
    jsonld: buildVacationRentalLd({ id: "zandoli", nom: "Zandoli", desc: "Villa Zandoli à Sainte-Luce, Martinique. Piscine privée, vue mer, jardin tropical. 4 personnes.", prix: 180, capacite: 4, chambres: 2, coords: { lat: 14.4730, lng: -60.9196 }, photos: ["/photos/zandoli/01.webp","/photos/zandoli/02.webp","/photos/zandoli/03.webp","/photos/zandoli/04.webp"] }),
  },
  {
    path: "/iguana",
    ...
    jsonld: buildVacationRentalLd({ id: "iguana", nom: "Villa Iguana", desc: "Villa Iguana à Sainte-Luce, Martinique. Piscine eau salée, vue panoramique sur le Rocher du Diamant. 6 personnes. Location longue durée.", capacite: 6, chambres: 3, coords: { lat: 14.4725, lng: -60.9192 }, photos: ["/photos/iguana/01.webp","/photos/iguana/02.webp","/photos/iguana/03.webp","/photos/iguana/04.webp"], bookable: false }),
  },
  {
    path: "/geko",
    title: "Géko — Location villa Martinique vue mer Sainte-Luce | Résidence Amaryllis",
    desc:  "Villa Géko à Sainte-Luce, Martinique. Vue mer, piscine partagée résidence, terrasse privée. 4 personnes. À partir de 130€/nuit. Réservation directe.",
    image: `${BASE}/photos/geko/01.webp`,
    jsonld: buildVacationRentalLd({ id: "geko", nom: "Géko", desc: "Villa Géko à Sainte-Luce, Martinique. Vue mer, piscine partagée résidence, terrasse privée. 4 personnes.", prix: 130, capacite: 4, chambres: 2, coords: { lat: 14.4732, lng: -60.9196 }, photos: ["/photos/geko/01.webp","/photos/geko/02.webp","/photos/geko/03.webp","/photos/geko/04.webp"] }),
  },
  {
    path: "/mabouya",
