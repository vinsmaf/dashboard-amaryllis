...
import PnlSejourTab from "./tabs/PnlSejourTab.jsx";
...
export { REVENUS_CANAL_2025 } from "./data/revenusCanal.js";
  ...
  const NAV_GROUPS = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pnl-sejour", icon: "🧮", label: "P&L par séjour" },
    ...
    },
    {
      ...
      items: [
        { id: "articles",        icon: "📝", label: "Articles SEO" },
      ...
      <div style={{ display: "flex", flex: 1, minHeight: 0 }}>
        ...
        <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ padding: mob ? "12px" : "18px 24px", flex: 1, paddingBottom: "calc(76px + env(safe-area-inset-bottom))" }}>
            ...
            {tab === "leads"         && <LeadsTab token={sessionStorage.getItem("ldb_tok") || ""} />}
            </LocalErrorBoundary>
          </div>
          </AppDataProvider>
        </div>
