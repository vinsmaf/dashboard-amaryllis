...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: <>
          <p>Entre <strong>500€ et 1 000€</strong> selon la villa. Pré-autorisée sur votre carte au moment de la réservation, jamais débitée si vous nous rendez la villa dans l'état où vous l'avez trouvée — et libérée automatiquement 3 jours après votre départ.</p>
        </>,
      },
    ],
  },
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "mainEntity": [
          ...
          { "@type": "Question", "name": "Quel est le montant de la caution pour une villa ?", "acceptedAnswer": { "@type": "Answer", "text": "Entre 500€ et 1 000€ selon la villa. La caution est uniquement pré-autorisée sur votre carte (jamais débitée) et libérée automatiquement 3 jours après votre départ si la villa est rendue en bon état." } },
