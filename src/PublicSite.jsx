...
const BIENS = [
  ...
  },
  {
    ...
    descFull: [
      { titre: "À l'étage", texte: "Une terrasse panoramique donnant sur la mer des Caraïbes, le Rocher du Diamant et l'île de Sainte-Lucie, en communication directe avec la cuisine et le salon — table, 6 chaises et hamac pour vos moments de détente. Un espace de vie avec canapé convertible, table basse et TV. Une cuisine toute équipée — réfrigérateur, plaques de cuisson, four combiné, micro-ondes, cafetière, toaster.", photos: ["/photos/iguana/04.webp", "/photos/iguana/07.webp"] },
      { titre: "Au rez-de-chaussée", texte: "Deux chambres climatisées avec lit Queen Size 160×200, tables de chevet et grands dressings avec penderie. Une salle de bain fonctionnelle avec douche et WC.", photos: [
        { src: "/photos/iguana/09.webp", label: "Chambre 1" },
        { src: "/photos/iguana/14.webp", label: "Chambre 2" },
      ] },
      { titre: "Les extérieurs", texte: "Un grand jardin fleuri avec table et chaises pour savourer un café ou un petit-déjeuner en plein air. Une piscine hors-sol de 3,66 m de diamètre. Un espace barbecue à gaz 2 feux avec tous les accessoires fournis. Deux places de parking extérieures privatives.", photos: ["/photos/iguana/08.webp", "/photos/iguana/06.webp"] },
  ...
  },
  {
    ...
    descFull: [
      { titre: "L'hébergement", texte: "L'appartement dispose d'une chambre avec lit double, d'une salle de bain moderne avec douche, et d'un salon-séjour lumineux avec accès direct à la grande terrasse orientée plein ouest — le lieu idéal pour vos soirées face au spectacle du soleil sur la baie.", photos: ["/photos/schoelcher/14.webp", "/photos/schoelcher/01.webp"] },
  ...
  },
  {
    ...
    descFull: [
      { titre: "L'hébergement", texte: "Votre cocon chic dispose d'une grande chambre avec lit King Size, d'un dressing spacieux et d'une TV. Le confort est digne d'un hôtel haut de gamme, dans un cadre élégant et apaisant.", photos: ["/photos/nogent/07.webp", "/photos/nogent/11.webp"] },
      { titre: "Espace de vie", texte: "La cuisine ultra-équipée invite à créer de délicieux repas, tandis que le salon lumineux s'ouvre sur l'extérieur. La connexion entre intérieur et extérieur est fluide, idéale pour savourer chaque moment en toute convivialité.", photos: ["/photos/nogent/14.webp", "/photos/nogent/05.webp"] },
      { titre: "Jardin & terrasse", texte: "Un jardin et une terrasse 100% privés — votre coin de paradis vert au cœur de la ville. Matins tranquilles au soleil, dîners sous les étoiles ou détente sur un transat. Le barbecue est à votre disposition pour des instants gourmands.", photos: ["/photos/nogent/09.webp", "/photos/nogent/03.webp"] },
                    ...
                    <Fragment key={i}>
                      ...
                      <div style={s.titre === "Votre hôte"
                        ...
                        {s.photos && s.photos.length > 0 && (
                          <div style={{ display: "grid", gridTemplateColumns: `repeat(${Math.min(s.photos.length, isMobile ? 2 : 3)}, 1fr)`, gap: 12, marginTop: 16 }}>
                            {s.photos.map(p => {
                              const src = typeof p === "string" ? p : p.src;
                              const label = typeof p === "string" ? null : p.label;
                              const idx = photos.indexOf(src);
                              return (
                                <div key={src} style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                                  <div
                                    onClick={() => { if (idx >= 0) { setPhotoIdx(idx); setLightboxOpen(true); } }}
                                    style={{ cursor: idx >= 0 ? "zoom-in" : "default", borderRadius: 12, overflow: "hidden" }}
                                  >
                                    <RImg
                                      src={src}
                                      alt={label ? `${bien.nom} — ${label}` : `${bien.nom} — ${s.titre}`}
                                  ...
                                  {label && (
                                    <span style={{ fontFamily: "'Jost', sans-serif", fontWeight: 500, fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", color: MUTED, textAlign: "center" }}>
                                      {label}
                                    </span>
                                  )}
                                </div>
