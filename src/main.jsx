...
import { isStaleChunkError } from './lib/staleChunk.js'
...
// Détection factorisée dans lib/staleChunk.js (réutilisée par bugCapture.js pour ne pas
// remonter ce faux-positif en bug — cf. bug-412b34c9c61b8070, récurrent via crawlers).
...
const EtatDesLieux      = lazy(() => import('./EtatDesLieux.jsx'))
const EtatDesLieuxMenage = lazy(() => import('./EtatDesLieuxMenage.jsx'))
...
} else if (path === "/etat-des-lieux-menage") {
  Component = EtatDesLieuxMenage;
} else if (path === "/etat-des-lieux") {
