 ...
 * Refonte 2026-06-07 v2 : supprime le système fantôme (multiplicateurs/aperçu)
 * et intègre TarifsOverview + TarifsQuickSeason + CalendrierTarifs.
 *
 * ⚠️ Règle critique (cf. .memory/LEARNINGS.md 2026-06-07) :
 * Les sous-composants TarifsOverview / TarifsQuickSeason ne doivent JAMAIS
 * faire d'opération sur un import App.jsx au top-level du module (circularité).
 */
